...
* substitute multi-term keywords into a string with no white spaces (list of terms from a file)
* remove stop words
...
write.csv(termFreq, file="TermFrequency_adjusted_7.csv")

dplyr::filter(termFreq, frequency >= 20) %>% dplyr::arrange(desc(frequency()))
```
